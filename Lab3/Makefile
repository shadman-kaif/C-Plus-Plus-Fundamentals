...
LAB_ROOT_DIR = $(ECE244_ROOT_DIR)/lab3
...
LAB_RELEASE_FILE = lab3_release.zip
...
../exe/$(EXECUTABLE):	 $(patsubst %,../obj/%,$(STUDENT_OBJ_FILES)) Makefile
	$(CXX) $(patsubst %,../obj/%,$(STUDENT_OBJ_FILES)) -o ../exe/$(EXECUTABLE) $(LD_FLAGS)

../obj/%.o:	../parser/%.cpp  Makefile
	$(CXX) $(CXX_FLAGS) -c $< -o $@
